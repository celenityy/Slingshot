...
%install
install -Dm644 %{_sourcedir}/slingshot/etc/chrony.brace.conf %{buildroot}/etc/chrony.brace.conf;
...
install -Dm644 %{_sourcedir}/slingshot/etc/dconf/db/local.d/00-brace-gnome %{buildroot}/etc/dconf/db/local.d/00-brace-gnome;
...
install -Dm644 %{_sourcedir}/slingshot/etc/profile.d/brace-env-overrides.sh %{buildroot}/etc/profile.d/brace-env-overrides.sh;
install -Dm644 %{_sourcedir}/slingshot/etc/profile.d/brace-helpers.sh %{buildroot}/etc/profile.d/brace-helpers.sh;
install -Dm644 %{_sourcedir}/slingshot/etc/tlp.d/00-brace.conf %{buildroot}/etc/tlp.d/00-brace.conf;
install -Dm644 %{_sourcedir}/slingshot/etc/chromium/policies/managed/brace.json %{buildroot}/etc/chromium/policies/managed/brace.json;
install -Dm644 %{_sourcedir}/slingshot/etc/chromium/policies/managed/brace.json %{buildroot}/etc/opt/chrome/policies/managed/brace.json;
install -Dm644 %{_sourcedir}/slingshot/usr/lib/modprobe.d/brace.conf %{buildroot}/usr/lib/modprobe.d/brace.conf;
...
install -Dm755 %{_sourcedir}/slingshot/usr/bin/brace-supplemental-changes %{buildroot}/usr/bin/brace-supplemental-changes;
